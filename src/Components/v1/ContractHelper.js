...
let decentBetTokenInstance, houseInstance, bettingProviderInstance,
    gameChannelManagerInstance, slotsChannelManagerInstance

const TYPE_DBET_TOKEN = 0, TYPE_DBET_HOUSE = 1, TYPE_DBET_BETTING_PROVIDER = 4,
    TYPE_DBET_GAME_CHANNEL_MANAGER = 5, TYPE_DBET_SLOTS_CHANNEL = 6, TYPE_DBET_SLOTS_CHANNEL_MANAGER = 7
            ...
            slotsChannel: (slotsChannelInstance) => {
                return {
                    ...
                    finalize: (currSpin, prevSpin) => {
                        ...
                        return slotsChannelInstance.finalize.sendTransaction(currSpin.parts, prevSpin.parts,
                            currSpin.r, currSpin.s, prevSpin.r, prevSpin.s,
                            {from: window.web3.eth.defaultAccount, gas: 3000000})
                    },
                    getSpinHash: (spin) => {
                    ...
                    checkSig: (hash, sig, turn) => {
                        return slotsChannelInstance.checkSig.call(hash, sig, turn)
                    },
                    claim: () => {

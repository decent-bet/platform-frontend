 ...
 */
export default class BettingReturnsCalculator {
    ...
    getSpreadReturns = (
        ...
        let spreadOutcome = this._getSpreadOutcome(
            amount,
            handicap,
            team1Points,
            team2Points,
        ...
        if (difference < 0) {
            ...
            if (handicap <= 0) {
                if (handicap === -25) {
                    ...
                    return constants.SPREAD_OUTCOME_DRAW
                } else return constants.SPREAD_OUTCOME_LOSS
            } else {
                if (handicap === 25) {
                    return constants.SPREAD_OUTCOME_HALF_WIN
                } else return constants.SPREAD_OUTCOME_WIN
            }
        }
        return constants.SPREAD_OUTCOME_LOSS
    }

function CPayTablePanel() {
    ...
    this.unload = function () {
        var oParent = this;
        _oContainer.off("pressup", function () {
            oParent._onExit()
        });
    ...
    this._createPayouts = function () {
        ...
        var aPos = [{x: 450, y: 122}, {x: 450, y: 302}, {x: 450, y: 486}, {x: 780, y: 122}, {x: 780, y: 302}, {
            x: 1100,
            y: 122
        }, {x: 1100, y: 302}];
        var iCurPos = 0;
    ...
    this.tweenAlpha = function (oText, iAlpha) {
        var oParent = this;
        createjs.Tween.get(oText).to({alpha: iAlpha}, 200).call(function () {
            if (iAlpha === 1) {

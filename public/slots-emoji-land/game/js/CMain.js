function CMain(oData) {
    ...
    this._initSounds = function () {
        ...
        createjs.Sound.registerSound("./sounds/background-2.mp3", "background2");
        createjs.Sound.registerSound("./sounds/press_but.mp3", "press_but");
        createjs.Sound.registerSound("./sounds/win.mp3", "win");
        createjs.Sound.registerSound("./sounds/win2.mp3", "win2");
        createjs.Sound.registerSound("./sounds/win3.mp3", "win3");
    ...
    this._loadImages = function () {
        ...
        s_oSpriteLibrary.addSprite("title", "./sprites/title.png");
    ...
    this.gotoMenu = function () {
        ...
        backgroundMusic = createjs.Sound.play('background2', { loop: -1, volume: 0.5 });
        _iState = STATE_MENU;
    };
    ...
    this.gotoGame = function () {
        ...
        backgroundMusic = createjs.Sound.play("background", {loop: -1, volume: 0.5});
        _iState = STATE_GAME;
    };

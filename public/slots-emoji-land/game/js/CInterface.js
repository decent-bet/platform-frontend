function CInterface(iCurBet, iTotBet, iMoney) {
    ...
    this._init = function(iCurBet, iTotBet, iMoney) {
        ...
        _oWinText = new createjs.Text('', '20px ' + FONT_GAME, '#032733')
        _oWinText.x = 1116
        ...
        const iHalfButHeight = oSprite.height / 2
        const iHalfButWidth = oSprite.width / 2
        const iPadding = 8
        const iSpriteHeight = 32
        let iYOffset = 92 + iHalfButHeight
        const iXOffset = 328 + iHalfButWidth
        ...
        iYOffset += iSpriteHeight + iPadding - 4
        ...
        iYOffset += iSpriteHeight + iPadding + 2
        ...
        iYOffset += iSpriteHeight + iPadding + 3
    ...
    this._onSpin = function() {
        ...
        parent.window.slotsController.spin(
            window.lines,
            window.betSize,
            (err, message, lines, updatedBalances) => {
                if (!err) {
                    ...
                    s_oGame.onSpin(lines, updatedBalances)
                } else {

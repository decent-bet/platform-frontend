function CGame(oData) {
    ...
    this.calculateWinningLine = function () {
        ...
        for (var k = 0; k < _iLastLineActive; k++) {
            ...
            console.log('Line ' + k + ': ' + s_aSymbolWin[iValue - 1][iNumEqualSymbol - 1]);
        ...
        console.log('Winning lines: ' + JSON.stringify(_aWinningLine) + ', ' + loops);
    };

    this.generateFinalSymbols = function (win) {
    ...
    this.onSpin = function (lines, updatedBalances) {
        var self = this;

        if(updatedBalances && updatedBalances.user) {
            TOTAL_MONEY = updatedBalances.user
        }
        ...
        //     //PLAYER MUST LOSE
        //     do {
        //         var bRet = this.generateFinalSymbols(1);
        //     } while (bRet === true);
        // } else {
        ...
        //         //PLAYER LOSES
        //         do {
        //             var bRet = this.generateFinalSymbols(2);
        //         } while (bRet === true);
        //
        //     } else {
        //         //PLAYER WINS
        //         do {
        //             var bRet = this.generateFinalSymbols(3);

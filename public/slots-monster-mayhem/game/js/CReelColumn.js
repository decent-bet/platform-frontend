function CReelColumn(iIndex, iXPos, iYPos, iDelay) {
    ...
    this.initContainer = function (iXPos, iYPos) {
        ...
        for (var i = 0; i < NUM_ROWS; i++) {
            ...
            var oSprite = createSprite(s_aSymbolData[iRandSymbol], "breathing", 0, 0, SYMBOL_SIZE, SYMBOL_SIZE);
            oSprite.x = iX;
            oSprite.y = iY;
    ...
    this.restart = function (aSymbols, bReadyToStop) {
        // if (bReadyToStop)
        //     console.log('Final restart: ' + _iIndex + ', ' + JSON.stringify(aSymbols));
        // else
        //     console.log('Non-Final restart: ' + _iIndex + ', ' + JSON.stringify(aSymbols));
        ...
        if (_bReadyToStop) {
            ...
            for (var i = 0; i < NUM_ROWS; i++) {
                _aSymbols[i].gotoAndPlay('breathing');
            }

function CMain(oData) {
    ...
    this._initSounds = function () {
        ...
        //Shared Sounds
        createjs.Sound.registerSound('./sounds/background.mp3', 'background1');
    ...
    this._loadImages = function () {
        ...
        for (var i = 1; i < NUM_SYMBOLS + 1; i++) {
            s_oSpriteLibrary.addSprite(`symbol_${i}_sprite`, `./sprites/symbol_${i}_sprite.png`)
    ...
    this.gotoGame = function () {
        ...
        createjs.Sound.play('background1', {loop: -1, volume: 0.5});
        _iState = STATE_GAME;
    };

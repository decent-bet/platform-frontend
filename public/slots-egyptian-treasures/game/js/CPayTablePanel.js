function CPayTablePanel(){
    ...
    this._init = function(){
        ...
        _oWildText = new createjs.Text(TEXT_HELP_WILD,"26px "+FONT_GAME, "#f8c86a");
    ...
    this._createPayouts = function(){
        ...
        var aPos = [{x:470,y:142},{x:470,y:322},{x:470,y:506},{x:800,y:142},{x:800,y:322},{x:1120,y:142},{x:1120,y:322}];
        var iCurPos = 0;
        for(var i=0;i<s_aSymbolWin.length;i++){
            ...
            for(var j=0;j<iLen;j++){
                ...
                var oText = new createjs.Text(aSymbolPayouts[iLen-j-1],"25px "+FONT_GAME, "#f8c86a");

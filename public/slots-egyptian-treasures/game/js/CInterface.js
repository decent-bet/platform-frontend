function CInterface(iCurBet, iTotBet, iMoney) {
    ...
    this._init = function(iCurBet, iTotBet, iMoney) {
        ...
        _oNumLinesText.y = CANVAS_HEIGHT - 98
        _oNumLinesText.textAlign = 'center'
        _oNumLinesText.textBaseline = 'alphabetic'
        s_oStage.addChild(_oNumLinesText)

        _oCoinText = new createjs.Text(iCurBet, '20px ' + FONT_GAME, '#f8c86a')
        _oCoinText.x = 712
        _oCoinText.y = CANVAS_HEIGHT - 98
        ...
        _oTotalBetText.y = CANVAS_HEIGHT - 98
        _oTotalBetText.textAlign = 'center'
        _oTotalBetText.textBaseline = 'alphabetic'
        s_oStage.addChild(_oTotalBetText)

        _oWinText = new createjs.Text('', '20px ' + FONT_GAME, '#f8c86a')
        _oWinText.x = 1116
        _oWinText.y = CANVAS_HEIGHT - 98
        ...
        var iYOffset = 92 + iHalfButHeight
    ...
    this.refreshWinText = function(iWin) {
        _oWinText.text = TEXT_WIN + ' ' + iWin + TEXT_CURRENCY
    }
